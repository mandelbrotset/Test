...
+"File path: /tmp/downloads/elasticsearch/revisions/rev_04681_bbeb0/rev_04681-bbeb0/core/src/main/java/org/elasticsearch/search/suggest/term/TermSuggestParser.java";
		...
		List<String> lines = new ArrayList<String>(Arrays.asList(aFunction3.split("\n")));
		
		Conflict c = new Conflict(conflict3,"");
		FunctionParser.extractFunction((ArrayList<String>) lines, c.getFunctionName(), c.getParameterTypes());		
	}
}