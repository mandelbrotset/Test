...
public class ConflictTester {
	...
	public void test() {
		...
		String conflict2 = "Conflict type: SameSignatureCM" + "\n"
				+ "Merge Commit SHA-1: eed557742f5db7cd82d22b69a84220cc598fd744" + "\n"
				+ "Parent1 SHA-1: 04681ef6165a40192a6e268ca2df861d9d017f47" + "\n"
				+ "Parent2 SHA-1: bbeb09eae7ac3c5d9837bb26eacfac6bba468929" + "\n" + "Number of Conflicts: 1" + "\n"
				+ "Different Spacing: 0" + "\n" + "Consecutive Lines: 0" + "\n" + "Intersection: 0" + "\n"
				...
				+ "<<<<<<< /tmp/paola/paolaboarba/elasticsearch/fstmerge_tmp1462368288471/fstmerge_var1_6390924134105912809"
				+ "\n" + "@Override" + "\n"
				+ "    public SuggestionSearchContext.SuggestionContext parse(XContentParser parser) throws IOException {"
				+ "\n" + "        MapperService mapperService = shardContext.getMapperService();" + "\n"
				+ "        XContentParser.Token token;" + "\n" + "        String fieldName = null;" + "\n"
				+ "        TermSuggestionContext suggestion = new TermSuggestionContext(suggester);" + "\n"
				+ "        DirectSpellcheckerSettings settings = suggestion.getDirectSpellCheckerSettings();" + "\n"
		...
		String conflict3 = "Conflict type: SameSignatureCM" + "\n"
				+ "Merge Commit SHA-1: eed557742f5db7cd82d22b69a84220cc598fd744" + "\n"
				+ "Parent1 SHA-1: 04681ef6165a40192a6e268ca2df861d9d017f47" + "\n"
				+ "Parent2 SHA-1: bbeb09eae7ac3c5d9837bb26eacfac6bba468929" + "\n" + "Number of Conflicts: 1" + "\n"
				+ "Different Spacing: 0" + "\n" + "Consecutive Lines: 0" + "\n" + "Intersection: 0" + "\n"
				...
				+ "<<<<<<< /tmp/paola/paolaboarba/elasticsearch/fstmerge_tmp1462368288471/fstmerge_var1_6390924134105912809"
				+ "\n" + "@Override" + "\n"
				+ "    public SuggestionSearchContext.SuggestionContext parse() throws IOException {" + "\n"
				+ "        MapperService mapperService = shardContext.getMapperService();" + "\n"
				+ "        XContentParser.Token token;" + "\n" + "        String fieldName = null;" + "\n"
				+ "        TermSuggestionContext suggestion = new TermSuggestionContext(suggester);" + "\n"
				+ "        DirectSpellcheckerSettings settings = suggestion.getDirectSpellCheckerSettings();" + "\n"
		...
		String aFunction = "        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {" + "\n"
				+ "            if (token == XContentParser.Token.FIELD_NAME) {" + "\n"
				+ "                fieldName = parser.currentName();" + "\n"
				+ "            } else if (token.isValue()) {" + "\n"
				+ "                parseTokenValue(parser, mapperService, fieldName, suggestion, settings, mapperService.getIndexSettings().getParseFieldMatcher());"
		...
		String aFunction2 = "        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {" + "\n"
				+ "            if (token == XContentParser.Token.FIELD_NAME) {" + "\n"
				+ "                fieldName = parser.currentName();" + "\n"
				+ "            } else if (token.isValue()) {" + "\n"
				+ "                parseTokenValue(parser, mapperService, fieldName, suggestion, settings, mapperService.getIndexSettings().getParseFieldMatcher());"
		...
		String aFunction3 = "        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {" + "\n"
				+ "            if (token == XContentParser.Token.FIELD_NAME) {" + "\n"
				+ "                fieldName = parser.currentName();" + "\n"
				+ "            } else if (token.isValue()) {" + "\n"
				+ "                parseTokenValue(parser, mapperService, fieldName, suggestion, settings, mapperService.getIndexSettings().getParseFieldMatcher());"
		...
		String expected = "    public SuggestionSearchContext.SuggestionContext parse(XContentParser parser, QueryShardContext shardContext) throws IOException {"
				+ "\n" + "        MapperService mapperService = shardContext.getMapperService();" + "\n"
				+ "        XContentParser.Token token;" + "\n" + "        String fieldName = null;" + "\n"
				+ "        TermSuggestionContext suggestion = new TermSuggestionContext(shardContext);" + "\n"
				+ "        DirectSpellcheckerSettings settings = suggestion.getDirectSpellCheckerSettings();" + "\n"
		...
		String expected2 = "    public SuggestionSearchContext.SuggestionContext parse(XContentParser parser) throws IOException {"
				+ "\n" + "        MapperService mapperService = shardContext.getMapperService();" + "\n"
				+ "        XContentParser.Token token;" + "\n" + "        String fieldName = null;" + "\n"
				+ "        TermSuggestionContext suggestion = new TermSuggestionContext(shardContext);" + "\n"
				+ "        DirectSpellcheckerSettings settings = suggestion.getDirectSpellCheckerSettings();" + "\n"
		...
		String expected3 = "    public SuggestionSearchContext.SuggestionContext parse() throws IOException {" + "\n"
				+ "        MapperService mapperService = shardContext.getMapperService();" + "\n"
				+ "        XContentParser.Token token;" + "\n" + "        String fieldName = null;" + "\n"
				+ "        TermSuggestionContext suggestion = new TermSuggestionContext(shardContext);" + "\n"
				+ "        DirectSpellcheckerSettings settings = suggestion.getDirectSpellCheckerSettings();" + "\n"
		...
		String[] conflicts = { conflict, conflict2, conflict3 };
		String[] functions = { aFunction, aFunction2, aFunction3 };
		String[] expecteds = { expected, expected2, expected3 };

		for (int i = 0; i < 3; i++) {
			Conflict c = new Conflict(conflicts[i], "");
			List<String> lines = new ArrayList<String>(Arrays.asList(functions[i].split("\n")));
			ArrayList<String> test = FunctionParser.extractFunction((ArrayList<String>) lines, c.getFunctionName(),
					c.getParameterTypes());
			StringBuilder sb = new StringBuilder();
			for (String line : test) {
				sb.append(line + "\n");
			}
			assertEquals(expecteds[i], sb.toString());
		}
	}
}