...
\begin{figure}[htp]
  \begin{center}
    \subfigure[The branches Branch A and Branch B both points at their respective tip commit.]{\label{fig:branch1}\includegraphics[width=200]{figure/branch1.png}}
    \subfigure[When merged, both branches points at the merge commit.]{\label{fig:branch2}\includegraphics[width=200]{figure/branch1.png}} \\
    \subfigure[If Branch A is checked out and then committed to, Branch B will still point at the merge commit.]{\label{fig:branch3}\includegraphics[width=200]{figure/branch1.png}}
  \end{center}
