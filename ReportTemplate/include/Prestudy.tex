...
\begin{figure}[htp]
  \begin{center}
    \subfigure[The branches Branch A and Branch B both points at their respective tip commit.]{\label{fig:edge-a}\includegraphics[scale=0.75]{figure/}}
    \subfigure[When merged, both branches points at the merge commit.]{\label{fig:edge-b}\includegraphics[scale=0.75]{laplace_toucan.eps}} \\
    \subfigure[If Branch A is checked out and then committed to, Branch B will still point at the merge commit.]{\label{fig:edge-c}\includegraphics[scale=0.75]{sobel_toucan.eps}}
  \end{center}
