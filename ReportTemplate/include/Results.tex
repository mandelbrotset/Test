...
\caption{Classification of conflicts for each category.}\label{fig:set}
\end{figure}
...
\caption{Resolution categorization where X is the left version and Y is the right version.}\label{fig:setleft}
\end{figure}
