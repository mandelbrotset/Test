...
\caption{Classification of conflicts in for each category.}\label{fig:setright}
\end{figure}
...
\caption{Classification of conflicts in for each category for the LEFT versions..}\label{fig:setright}
\end{figure}
...
\caption{Classification of conflicts in for each category for the RIGHT versions.}\label{fig:setright}
\end{figure}
