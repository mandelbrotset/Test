...
\begin{figure}
\begin{tikzpicture}
 \begin{axis}[ybar stacked,symbolic x coords={Superset,Intersection},xtick=data,enlarge x limits={abs=1.5cm},xlabel=\textbf{Category},ylabel=\textbf{Left versions},legend pos=outer north east]
...
\legend{Chosen, Not chosen}
 \end{axis}
\end{tikzpicture}
\caption{Number of left versions that are either a superset or an intersection}\label{fig:setleft}
\end{figure}

\begin{figure}
\begin{tikzpicture}
 \begin{axis}[ybar stacked,symbolic x coords={Superset,Intersection},xtick=data,enlarge x limits={abs=1.5cm},xlabel=\textbf{Category},ylabel=\textbf{Right versions},legend pos=outer north east]
